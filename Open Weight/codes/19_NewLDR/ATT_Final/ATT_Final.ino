...
#define ldr_front !digitalRead(PA4)
#define ldr_right !digitalRead(PA5)
#define ldr_back !digitalRead(PA6)
#define ldr_left !digitalRead(PA7)
...
float goal_y_pixy;
///////////////////////////////////////////// ROBOT 1
int robot_x_1 = 168;  // OpenMV
int robot_y_1 = 116;  // OpenMV
int robot_x_pixy_1 = 156;
int robot_y_pixy_1 = 250;
///////////////////////////////////////////// ROBOT 2
int robot_x_2 = 159;  // OpenMV
int robot_y_2 = 118;  // OpenMV
