...
void out() {
  ...
  else if (ldr.front > LDR_SENS) {moveSec(180, HIGH_SPEED, MOVE_INSIDE_SEC); out_ball_angle = 0;}
  else if (ldr.right > LDR_SENS) {moveSec(270, HIGH_SPEED, MOVE_INSIDE_SEC); out_ball_angle = 90;}
  else if (ldr.back > LDR_SENS) {moveSec(0, HIGH_SPEED, MOVE_INSIDE_SEC); out_ball_angle = 180;}
