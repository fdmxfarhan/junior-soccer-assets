...
int robot_y_1 = 136;  // OpenMV
int robot_x_2 = 158;  // OpenMV
int robot_y_2 = 126;  // OpenMV
int robot_x;
int robot_y;
int robot_id;
int shl, shb, shr, D;
...
void setup() {
  ...
  // true = darvazevan
  // false = mohajem
  if(robot_id == 1) IS_Goaler =false;
  if(robot_id == 2)  IS_Goaler = true;
}
